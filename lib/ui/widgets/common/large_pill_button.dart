...
/// A large gel pill-style button that uses a single background image
/// [AppImages.btnLarge] and overlays Baloo text label.
///
/// Sizing:
/// - Width is required; height is derived from width using an aspect ratio.
/// - The text is centered, white with shadow by default to match the design.
///
/// Usage:
/// LargePillButton(width: 320, label: 'PLAY', onTap: ...);
